...
public class Miakyznak extends Test {
    ...
    public Miakyznak(String question, String rightanswer, String wronganserone, String wrongansertwo, String wronganserthree) {
