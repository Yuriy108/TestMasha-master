...
public class WritingNo extends Test {
    ...
    public WritingNo(String question, String rightanswer, String wronganserone, String wrongansertwo, String wronganserthree) {
